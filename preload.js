...
contextBridge.exposeInMainWorld('lab', {
  ...
  onUpdateProgress: (fn) => ipcRenderer.on('update-progress', (_e, info) => fn(info)),
  ...
  communitySearch: (filters, scope) => ipcRenderer.invoke('community-search', filters, scope),
  communityForGame: (dir) => ipcRenderer.invoke('community-for-game', dir),
  communityGpus: () => ipcRenderer.invoke('community-gpus'),
